...
import { sneakos } from "../assets/images"
  ...
  return (
    <footer className="max-container">
      ...
      gap-20 flex-wrap max-lg:flex-col">
        ...
        text-white-400 sm:max-w-sm ">Get your shoes ready at the nearest store. Find the perfect fit.</p>
      ...
      mt-24 max-sm:flex-col max-sm:items-center">
        <div className="flex flex-1 justify-start items-center font-montserrat
